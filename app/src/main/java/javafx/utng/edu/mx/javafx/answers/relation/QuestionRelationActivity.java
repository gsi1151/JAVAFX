...
public class QuestionRelationActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        QuizRelationHelper db = new QuizRelationHelper(this);  // Mi clase de banco de preguntas
    ...
    public void getAnswer(String AnswerString) {
        if (currentQ.getANSWER().equals(AnswerString)) {
            ...
            Intent intent = new Intent(QuestionRelationActivity.this,
