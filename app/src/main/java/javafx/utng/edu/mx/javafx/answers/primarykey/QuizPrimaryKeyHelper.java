package javafx.utng.edu.mx.javafx.answers.primarykey;
...
public class QuizPrimaryKeyHelper extends SQLiteOpenHelper {
	...
	private void addQuestion() {
		Question q1 = new Question("¿Cual es el metodo principal para las aplicaciones de javafx?",
				"start();",
				"run();",
				"sleep();",
				"start();");
		...
		Question q2 = new Question("Es una etapa en javafx",
				"Scene",
				"Container",
				"Stage",
				"Stage");
		...
		Question q3 = new Question("Es la clase que engloba todo el contenido",
				"Scene",
				"Container",
				"Stage",
				"Scene");
		...
		Question q4 = new Question("Esun nodo de diseño",
				"layout",
				"scene",
				"interfaz",
				"layout");
		...
		Question q5 = new Question("Este metodo no es necesario en javafx",
				"start();",
				"show();",
				"main();",
				"main();");
