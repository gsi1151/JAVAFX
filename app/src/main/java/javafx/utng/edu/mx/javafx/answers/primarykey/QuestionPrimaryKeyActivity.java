...
import javafx.utng.edu.mx.javafx.TemarioActivity;
import javafx.utng.edu.mx.javafx.answers.Question;


public class QuestionPrimaryKeyActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        QuizPrimaryKeyHelper db = new QuizPrimaryKeyHelper(this);  // Mi clase de banco de preguntas
    ...
    public void getAnswer(String AnswerString) {
        if (currentQ.getANSWER().equals(AnswerString)) {
            ...
            Intent intent = new Intent(QuestionPrimaryKeyActivity.this,
